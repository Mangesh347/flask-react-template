...
# from modules.application.application_service import ApplicationService   # Disabled Temporal
from modules.application.errors import AppError  # , WorkerClientConnectionError  # Removed WorkerClientConnectionError (Temporal)
# from modules.application.workers.health_check_worker import HealthCheckWorker    # Disabled Temporal worker
...
# Connect to Temporal Server (Disabled for now)
"""
try:
...
# Register Comments API
from modules.comments.rest_api.comment_rest_api_server import comment_blueprint
